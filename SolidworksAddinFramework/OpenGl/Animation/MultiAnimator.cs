...
namespace SolidworksAddinFramework.OpenGl.Animation
{
    public sealed class MultiAnimator : AnimatorBase
    {
        ...
        public override void Render(DateTime now, IDrawContext drawContext, double parentOpacity = 1.0, Matrix4x4? renderTransform = null)
        {
            if (_Animators.Count == 0) return;
            ...
            FindAnimator(time).Render(_ReferenceTime + time,drawContext, Opacity * parentOpacity, renderTransform);
        }
