...
namespace SolidworksAddinFramework.OpenGl.Animation
{
    public class Animator : AnimatorBase
    {
        ...
        public override void Render(DateTime t, IDrawContext drawContext, double parentOpacity = 1.0, Matrix4x4? renderTransform = null)
        {
            if (!Visibility)
                return;
            ...
            foreach (var child in _Children)
            {
                ...
                child.Render(t, drawContext,  Opacity*parentOpacity);
            }
        }
    }
}