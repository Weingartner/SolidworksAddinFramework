...
namespace SwCSharpAddinMF.Spec
{
    public class SampleMacroFeatureSpec : SolidWorksSpec
    {
        ...
        public void ShouldBeAbleToApplySampleMacroFeature()
        {
            ...
            var lines = modelDoc.SketchManager.CreateCornerRectangle(-0.02, 0.01, 0, 0.02, -0.01, 0).CastArray<ISketchSegment>();
            // Sketch to extrude
            Assert.True(modelDoc.Extension.SelectByID2("Sketch1", "SKETCH", 0, 0, 0, false, 0, null, 0));
            // Start condition reference
            Assert.True(modelDoc.Extension.SelectByID2("Plane2", "PLANE", 0.00105020593408751, -0.00195369982668282, 0.0248175428318827, true, 32, null, 0));
            // End condition reference
            Assert.True(modelDoc.Extension.SelectByID2("Plane1", "PLANE", 0.0068370744701368, -0.004419862088339, 0.018892268568016, true, 1, null, 0));
